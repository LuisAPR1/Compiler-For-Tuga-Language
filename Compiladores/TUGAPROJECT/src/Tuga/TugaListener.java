...
public interface TugaListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterLogicalAnd(TugaParser.LogicalAndContext ctx);
	/**
	 * Exit a parse tree produced by the {@code LogicalAnd}
	 * labeled alternative in {@link TugaParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitLogicalAnd(TugaParser.LogicalAndContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterLogicalOr(TugaParser.LogicalOrContext ctx);
	/**
	 * Exit a parse tree produced by the {@code LogicalOr}
	 * labeled alternative in {@link TugaParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitLogicalOr(TugaParser.LogicalOrContext ctx);
	/**
